...
module.exports.findProfile = async function findProfile(req, res, next) {
...
module.exports.findProfileByUsername = async function findProfileByUsername(req, res, next) {
...
module.exports.writeProfile = async function writeProfile(req, res, next) {
...
module.exports.clearProfile = async function clearProfile(req, res, next) {
...
module.exports.updateProfileByUsername = async function updateProfileByUsername(req, res, next) { // Admin Only
    const params = req.params.username;
...
module.exports.deleteProfileByUsername = async function deleteProfileByUsername(req, res, next){   // Admin Only
    const params = req.params.username;
