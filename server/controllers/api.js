...
module.exports.getAPI = function getAPI(req, res) {
    res.status(200).json({ message: `Welcome to Camunited API` });
}

module.exports.getCamunitedAPI = function getCamunitedAPI(req, res) {
    res.status(200).json({
        message: `Welcome to Camunited Team API! ;)`
    })
}

module.exports.postHotel = async function postHotel(req, res, next) {
...
module.exports.updateHotel = async function updateHotel(req, res, next) {
...
module.exports.deleteHotel = async function deleteHotel(req, res, next) {
    const params = req.params.id;
    try {
...
module.exports.findHotels = async function findHotels(req, res, next) {
    try {
...
module.exports.findHotel = async function findHotel(req, res, next) {
    const params = req.params.id;
    try {
...
module.exports.countByCity = async function countByCity(req, res, next) {
...
module.exports.countByType = async function countByType(req, res, next) {
...
module.exports.postRoom = async function postRoom(req, res, next) {
    const { username } = req.user;
...
module.exports.updateRoom = async function updateRoom(req, res, next) {
    const params = req.params.id;
    const request = req.body;
    try {
...
module.exports.deleteRoom = async function deleteRoom(req, res, next) {
...
module.exports.findRooms = async function findRooms(req, res, next) {
    try {
...
module.exports.findRoom = async function findRoom(req, res, next) {
    const params = req.params.id;
    try {
