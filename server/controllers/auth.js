...
module.exports.getHello = function getHello(req, res) {
...
module.exports.sendEmailConfirm = async function sendEmailConfirm(req, res, next) {
...
module.exports.verifyEmail = async function verifyEmail(req, res, next) {
...
module.exports.altPasswordConfirm = async function altPasswordConfirm(req, res, next) {
...
module.exports.deleteAccountByUsername = async function deleteAccountByUsername(req, res, next) {
    try {
...
module.exports.changeEmail = async function changeEmail(req, res, next) {
    const { altid } = req.user;
    const { email } = req.body;
...
module.exports.findEmailByUsername = async function findEmailByUsername(req, res, next) {
...
module.exports.changeUsername = async function changeUsername(req, res, next) {
    const { altid } = req.user;
    const { username } = req.body;
