...
module.exports.InitOnlyEmailConfirmation = async function InitOnlyEmailConfirmation (req, res, next) {
...
module.exports.InitpreferedTwoFAOption = async function InitpreferedTwoFAOption (req, res, next) {
    const { altid } = req.user;
